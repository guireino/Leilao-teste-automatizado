...
import br.com.alura.leilao.ui.AtualizarLeiloes;
...
public class ListaLeilaoActivity extends AppCompatActivity{
    ...
    private static final String MENSAGEM_AVISO_FALHA = "Não foi possível carregar os leilões";

    private ListaLeilaoAdapter adapter;

    private final LeilaoWebClient client = new LeilaoWebClient();
    private final AtualizarLeiloes atualizarLeiloes = new AtualizarLeiloes();
    ...
    protected void onResume(){
        super.onResume();
        AtualizarLeiloes.buscarLeiloes(adapter, client, new AtualizarLeiloes.ErroCarregaLeiloes(){
            @Override
            public void erroCarregar(String mensagem){
                showMensagemFalha();
            }
        });
    }

    public void showMensagemFalha(){
        Toast.makeText(this, MENSAGEM_AVISO_FALHA, Toast.LENGTH_SHORT).show();
    }
