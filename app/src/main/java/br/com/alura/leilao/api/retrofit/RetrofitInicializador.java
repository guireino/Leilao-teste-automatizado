...
public class RetrofitInicializador{
    ...
    private static final String URL_BASE = "http://192.168.1.4:8080/";
    private final Retrofit retrofit;

    public RetrofitInicializador(){
        OkHttpClient client = configuraHttpClient();
        retrofit = new Retrofit.Builder().baseUrl(URL_BASE).client(client).addConverterFactory(GsonConverterFactory.create()).build();
    }
